...
(function() {
  var RESERVED, clone, coffeescript, contains, existsSync, fs, installThenWriteBundle, isObject, isString, jsp, mb, path, pro, runInExecDir, spawn, wrench, _base, _ref;
  ...
  mb.writeBundle = function(filename, bundle, options, callback) {
    var ast, bundle_code, compressed_bundle, dir, directory, resolved_filename;
    if (!filename) {
  ...
  mb.writeBundles = function(config, options, callback) {
    var bundle, count, dir, filename, groupCallback, groupSuccess, installed_packages;
    if (!config) {
